  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full relative z-10 rounded-3xl p-5 space-y-4"
      ...
      >
        ...
        <div>
          ...
          <div className="flex items-center rounded-2xl overflow-hidden"
            ...
            <input
              ...
              value={shareUrl}
              dir="ltr"
              className="flex-1 bg-transparent text-white/80 text-xs px-3 py-3 outline-none min-w-0 font-mono"
            />
            <button
              onClick={handleCopy}
              className="px-3 py-3 flex items-center gap-1 text-sm font-semibold transition-all flex-shrink-0 border-s border-white/10"
        ...
        <div className="flex justify-center">
          <QRPlaceholder url={shareUrl} lang={lang} />
        </div>
        ...
        <motion.button
          ...
          className="w-full py-3 rounded-2xl font-bold text-white flex items-center justify-center gap-2 text-base"
